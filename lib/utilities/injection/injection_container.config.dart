...
import 'package:flutter_clean_architecture/platform/respository/restaurant_repository_impl.dart'
    as _i5;
import 'package:flutter_clean_architecture/presentation/restaurants/restaurant_list_cubit.dart'
    as _i3;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i3.RestaurantListCubit>(() => _i3.RestaurantListCubit(
        restaurantRepository: gh<_i4.RestaurantRepository>()));
    gh.factory<_i5.RestaurantRepostoryImpl>(() =>
